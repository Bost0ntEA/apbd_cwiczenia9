...
public partial class Cwiczenia9apbdContext : DbContext
{
    public Cwiczenia9apbdContext()
    {
    }

    public Cwiczenia9apbdContext(DbContextOptions<Cwiczenia9apbdContext> options)
        : base(options)
    {
    }

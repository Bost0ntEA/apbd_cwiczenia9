    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Jan@gg.com", "Jan", "Pierog" });

            migrationBuilder.InsertData(
                table: "Medicament",
                columns: new[] { "IdMedicament", "Description", "Name", "Type" },
                values: new object[] { 1, "boli", "Holochomikonafeloftalenion", "lecznicze" });

            migrationBuilder.InsertData(
                table: "Patient",
                columns: new[] { "IdPatient", "Birthdate", "FirstName", "LastName" },
                values: new object[] { 1, new DateTime(2000, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kaluch", "Kapszztyniarz" });

            migrationBuilder.InsertData(
                table: "Prescription",
                columns: new[] { "IdPrescription", "Date", "DueDate", "IdDoctor", "idPatient" },
                values: new object[] { 1, new DateTime(2024, 6, 12, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 6, 17, 14, 43, 3, 390, DateTimeKind.Local).AddTicks(3008), 1, 1 });

            migrationBuilder.InsertData(
                table: "Prescription_Medicament",
                columns: new[] { "IdMedicament", "IdPrescription", "Details", "Dose" },
                values: new object[] { 1, 1, "jest sobie krowka", 1 });
